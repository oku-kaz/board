...
abstract class Bd_Orm_Main_Base_Account extends Bd_Db_Record
{
    ...
    {
        if(isset($this->_relations['AutoLogin']) && $value != $this->getId())
        {
            unset($this->_relations['AutoLogin']);
        }
    ...
    /**
     * Generated by Sdx_Generator_Model_Relation_HasOne
     *
     * @return Bd_Orm_Main_AutoLogin
     */
    public function getAutoLogin($arg = null)
    {
        ...
        return $this->_relations['AutoLogin'] === null ? Sdx_Null::getInstance() : $this->_relations['AutoLogin'];
    }
     ...
     * @return Bd_Orm_Main_Account
     */
    public function setAutoLogin(Bd_Orm_Main_AutoLogin $record)
    {
        $this->_relation_save = true;
        
        $record->bindAccount($this);
        $this->setId($record->getAccountId());
        $this->_relations['AutoLogin'] = $record;
        return $this;
    }
